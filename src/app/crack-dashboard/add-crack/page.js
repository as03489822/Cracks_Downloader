...
const AddCrack = () => {
  ...
  const handleDetailsChange = (e) => {
    ...
    setForm((prev) => {
      ...
      console.log('71',ref)
      console.log('72',ref[keys[keys.length - 1]])
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Submitting Crack Data: ", dataToSend);
    ...
    <div className='flex h-screen text-white'>
      ...
      <div className='w-full bg-[#181D14] overflow-y-auto p-10'>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input name="image" value={form.image} onChange={handleChange} placeholder="Image path" className="rounded w-full bg-[#242e24] p-2" />
